 ...
 */
public class BottomAppBarHideOnScrollFragment extends DemoFragment implements OnBackPressedHandler {
  ...
  public int getBottomAppBarContent() {
    return R.layout.cat_bottomappbar_hide_on_scroll_fragment;
  }
