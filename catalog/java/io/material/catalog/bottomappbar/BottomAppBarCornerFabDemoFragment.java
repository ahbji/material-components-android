 ...
 */
public class BottomAppBarCornerFabDemoFragment extends DemoFragment implements OnBackPressedHandler {
  ...
  public int getBottomAppBarContent() {
    return R.layout.cat_bottomappbar_corner_fab_demo_fragment;
  }
