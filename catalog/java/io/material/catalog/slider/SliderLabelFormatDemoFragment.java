...
public class SliderLabelFormatDemoFragment extends DemoFragment {
  ...
  public View onCreateDemoView(
    ...
    View view =
        layoutInflater.inflate(R.layout.cat_slider_label_format_fragment, viewGroup, false /* attachToRoot */);

    Slider slider = view.findViewById(R.id.slider);
    slider.addOnSliderTouchListener(touchListener);
    slider.setLabelFormatter(createLabelFormatter());

    RangeSlider rangeSlider = view.findViewById(R.id.range_slider);
    rangeSlider.addOnSliderTouchListener(rangeSliderTouchListener);
    rangeSlider.setLabelFormatter(createLabelFormatter());
  ...
  @NonNull
  private LabelFormatter createLabelFormatter() {
    return (float value) -> {
      NumberFormat format = NumberFormat.getCurrencyInstance();
      format.setMaximumFractionDigits(0);
      format.setCurrency(Currency.getInstance("USD"));
      return format.format(Float.valueOf(value).doubleValue());
    };
  }
