...
public class NavigationRailHeaderDemoFragment extends DemoFragment {
  ...
  public View onCreateDemoView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
    View view = layoutInflater.inflate(R.layout.cat_navigation_rail_header_demo_fragment, viewGroup, false);
